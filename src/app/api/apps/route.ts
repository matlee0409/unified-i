...
import { composioFetch, filterConnectedApps, hasComposioKey } from '@/lib/server/composio';
...
export async function GET() {
  ...
  return NextResponse.json(filterConnectedApps(await toolkitsResponse.json(), await authConfigsResponse.json(), await connectedAccountsResponse.json()));
}
