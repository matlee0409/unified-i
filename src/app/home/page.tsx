  ...
  return (
    <main className="min-h-dvh overflow-y-auto bg-[var(--chat-canvas)] text-foreground">
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 lg:py-10">
        <section className="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between"><div><p className="text-sm font-medium text-primary">Live overview</p><h1 className="mt-1 text-3xl font-semibold tracking-tight sm:text-4xl">Good morning, Lee-Roy</h1><p className="mt-2 text-muted-foreground">Your connected channels and conversations, updated from Zernio.</p></div><Button asChild variant="outline" className="w-full bg-background sm:w-auto"><Link href="/inbox"><MessageSquare />Open inbox</Link></Button></section>
