        ...
        <div className="mt-8 space-y-6">
          <section className="rounded-xl border border-[var(--chat-border)] bg-card p-5 shadow-sm sm:p-6">
            ...
            <div className="mt-6 grid gap-5 sm:grid-cols-2">
              <div className="space-y-2"><Label htmlFor="model">Served model</Label><div className="relative"><select id="model" className="h-9 w-full appearance-none rounded-md border bg-background px-3 pr-9 text-sm outline-none focus:ring-2 focus:ring-ring"><option>meta/llama-3.3-70b-instruct</option><option>meta/llama-3.1-70b-instruct</option><option>mistralai/mixtral-8x22b-instruct-v0.1</option></select><ChevronDown className="pointer-events-none absolute top-1/2 right-3 size-4 -translate-y-1/2 text-muted-foreground" /></div><p className="text-xs text-muted-foreground">NVIDIA NIM served model name.</p></div>
              <div className="space-y-2"><Label htmlFor="endpoint">NIM endpoint</Label><Input id="endpoint" defaultValue="https://integrate.api.nvidia.com/v1" /><p className="text-xs text-muted-foreground">Keep credentials in your server environment.</p></div>
          ...
          <section className="rounded-xl border border-[var(--chat-border)] bg-card p-5 shadow-sm sm:p-6">
            ...
            <div className="mt-6 grid gap-5 sm:grid-cols-3"><div className="space-y-2"><Label htmlFor="duration">Meeting duration</Label><select id="duration" className="h-9 w-full rounded-md border bg-background px-3 text-sm"><option>30 minutes</option><option>45 minutes</option><option>60 minutes</option></select></div><div className="space-y-2"><Label htmlFor="buffer">Buffer between meetings</Label><select id="buffer" className="h-9 w-full rounded-md border bg-background px-3 text-sm"><option>None</option><option>10 minutes</option><option>15 minutes</option></select></div><div className="space-y-2"><Label htmlFor="timezone">Timezone</Label><select id="timezone" className="h-9 w-full rounded-md border bg-background px-3 text-sm"><option>Auto-detect</option><option>UTC</option><option>America/New_York</option><option>Europe/London</option></select></div></div>
